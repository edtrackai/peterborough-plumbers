...
export const metadata: Metadata = buildMetadata({
  title: "About Peterborough Plumbers | Local Engineers",
  description:
...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      />
      {/* Hero */}
      <PageHeroShell imageSrc="/images/homepage/hero.webp" imageAlt="Expert plumbers in Peterborough — qualified plumbing & heating engineers" priority>
