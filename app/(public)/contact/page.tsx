...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative bg-pp-navy pt-28 pb-14" style={{ minHeight: "clamp(560px, 56vw, 900px)" }}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white">
            Contact <span className="text-pp-teal">Peterborough Plumbers</span>
          </h1>
          <p className="mt-4 text-lg max-w-2xl text-white/80">
            Gas Safe registered engineers serving Peterborough and surrounding areas.
            Call for emergencies, or use the form below for standard enquiries and quotes.
          </p>
          {/* Response time badges */}
          <div className="mt-6 flex flex-wrap gap-4 text-sm">
            <span className="flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full">
            ...
            <span className="flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full">
              ...
              Gas Safe No. {siteSettings.gasSafeNumber}
            </span>
          </div>
        </div>
      </section>
