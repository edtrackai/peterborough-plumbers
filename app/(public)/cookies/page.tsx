    ...
    <>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-3xl px-4 space-y-6 text-pp-dark/80 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-pp-dark">What Are Cookies?</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">Cookies We Use</h2>
