...
export default function FaqPage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <PageHeroShell imageSrc="/images/faqs/hero.webp" imageAlt="Peterborough Plumbers qualified engineer ready to answer your questions" priority>
          <Breadcrumbs items={[{ name: "FAQs", href: "/faqs" }]} inverted />
