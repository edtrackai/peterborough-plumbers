    ...
    <>
      ...
      <section className="relative bg-pp-navy overflow-hidden flex flex-col hero-white-text min-h-[280px] sm:min-h-[clamp(400px,40vw,660px)]">
        <div className="absolute inset-0 z-0" aria-hidden="true">
          <Image src="/images/guides/hero.webp" alt="Plumber providing expert repairs and advice in Peterborough" fill className="object-cover object-center" priority quality={85} sizes="100vw" />
