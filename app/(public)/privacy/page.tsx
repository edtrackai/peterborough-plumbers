  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-3xl px-4 space-y-6 text-pp-dark/80 leading-relaxed">
          <p>Last updated: January 2025</p>
          <h2 className="text-2xl font-bold text-pp-dark">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">3. Data Sharing</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">4. Data Retention</h2>
          <p>We retain your data only as long as necessary to provide our services and comply with legal obligations.</p>
          <h2 className="text-2xl font-bold text-pp-dark">5. Your Rights</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">6. Contact</h2>
