    ...
    <>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-3xl px-4 space-y-6 text-pp-dark/80 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-pp-dark">1. Services</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">2. Quotes &amp; Pricing</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">3. Payment</h2>
          <p>Payment is due upon completion of work unless otherwise agreed. We accept bank transfer, cash, and major cards.</p>
          <h2 className="text-2xl font-bold text-pp-dark">4. Guarantees</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">5. Cancellations</h2>
          ...
          <h2 className="text-2xl font-bold text-pp-dark">6. Liability</h2>
