...
const NAV_SECTIONS = [
  ...
  {
    label: "Quotes & Variations",
    items: [
      { href: "/admin/quotes",     label: "Quotes",      Icon: QuoteIcon,     exact: false },
      { href: "/admin/variations", label: "Variations",  Icon: VariationIcon, exact: false },
    ],
  },
  {
    label: "Content",
    items: [
      ...
      { href: "/admin/templates", label: "Templates",  Icon: TemplateIcon, exact: false },
      { href: "/admin/config",    label: "Config",     Icon: ConfigIcon,   exact: false },
