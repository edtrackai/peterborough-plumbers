...
export default function WhatsAppFloatClient({ href }: { href: string }) {
  ...
  return (
    <div className={`hidden lg:block fixed ${bottom} right-4 z-[60] transition-all duration-500`}>
      {/* Pulse ring */}
      ...
      <a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.5)] hover:bg-[#22c55e] hover:scale-110 active:scale-95 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
      >
