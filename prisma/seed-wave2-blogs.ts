...
<p>Not sure where your inspection chambers are? Our <a href="/services/drain-blockages">drainage team</a> can locate, lift, and assess external chambers as part of any call-out. If the blockage appears to involve the shared network, we'll document the findings so you can report to Anglian Water with evidence. <a href="/book">Book online</a> or call 02039514510.</p>
...
<p><a href="/book">Book a drain survey</a> or call 02039514510 to discuss whether your property is at risk.</p>
...
<p>To book a CCTV drain survey across Peterborough and surrounding areas, <a href="/book">book online</a> or call 02039514510. For more on when a survey is the right tool, read our overview of <a href="/blog/cctv-drain-survey-peterborough">CCTV drain surveys in Peterborough</a>.</p>
...
<p>If a water meter test confirms a live leak, call a plumber first — the leak needs to be found and repaired before any damp assessment makes sense. If the meter is static and the damp pattern is consistent with rising damp (low level, tide mark, no appliance correlation), a specialist damp surveyor is the appropriate first step. If you're unsure, a combined moisture survey — using a plumber with leak detection equipment — will give you a definitive answer without guessing. <a href="/book">Book a survey</a> or call 02039514510.</p>
...
<p>To plan your en-suite project, read our guide on <a href="/blog/plan-bathroom-renovation-peterborough">planning a bathroom renovation in Peterborough</a>, or <a href="/book">book a survey and quote</a> with our <a href="/services/bathroom-installations">bathroom installations team</a>. Call 02039514510.</p>
...
<p>If the frozen pipe is in a loft, garage, or other unheated space and isn't easily insulated, our <a href="/services/plumbing-repairs">plumbing repairs</a> team can re-route the pipe through a more protected route or install appropriate lagging. <a href="/book">Book online</a> or call 02039514510.</p>
...
<p>Our <a href="/services/landlord-services">landlord services team</a> carries out pre-HMO-licence plumbing assessments across Peterborough — visiting the property, working through the relevant compliance requirements, and providing a written report of any gaps alongside a remediation plan. This gives you time to complete any required work before the council inspector visits. <a href="/book">Book an assessment online</a> or call 02039514510.</p>
...
<p>To discuss the right survey type for a specific property, <a href="/book">book online</a> or call 02039514510. Our <a href="/services/pre-purchase-plumbing-survey">pre-purchase survey service</a> covers Peterborough, Stamford, Market Deeping, Yaxley, and Whittlesey.</p>
...
<p>Our <a href="/services/damp-leak-detection">damp and leak detection surveys</a> use both methods where the case calls for it — combined with moisture meter mapping and tracer gas where depth accuracy is critical. <a href="/book">Book a detection survey</a> or call 02039514510.</p>
...
<p>For a central heating assessment or power flush across Peterborough, <a href="/book">book online</a> or call 02039514510.</p>
